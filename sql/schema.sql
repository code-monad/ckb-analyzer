...
SELECT create_hypertable('ckb_testnet.created_cell', 'time', migrate_data => true);
SELECT create_hypertable('ckb_testnet.spent_cell', 'time', migrate_data => true);

SELECT create_hypertable('ckb_dev.peer', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.block', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.epoch', 'start_time', migrate_data => true);
SELECT create_hypertable('ckb_dev.tx_pool_info', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.block_transaction', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.subscribed_new_transaction', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.subscribed_proposed_transaction', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.subscribed_rejected_transaction', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.retention_transaction', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.compact_block_first_seen', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.created_cell', 'time', migrate_data => true);
SELECT create_hypertable('ckb_dev.spent_cell', 'time', migrate_data => true);
